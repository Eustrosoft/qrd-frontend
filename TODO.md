...
- [ ] Генератор случайного pin2 - случайные цифры и латинские символы любого регистра от 12 до 16 символов
- [ ] Если pin2 md5 меняли - выдавать предупреждение, что точно хотите менять md5?
...
- [ ] Сделать формы создания/редактирования PIN
- [ ] Новые табы в просмотре карточки, отдельные компоненты создания / редактирования PIN
