...
export const ErrorsLocalization = {
  ...
  errorFetchingCardList: $localize`:@@errors.errorFetchingCardList:Error while fetching card list`,
  ...
  errorFetchingPCode: $localize`:@@errors.errorFetchingPCode:Error while fetching PIN code`,
} as const;
