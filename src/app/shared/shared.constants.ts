...
export const SharedLocalization = {
  ...
  data: $localize`:@@shared.data:Data`,
  type: $localize`:@@shared.type:Type`,
  ...
  openCard: $localize`:@@shared.openCard:Open card`,
  ...
  noGs1: $localize`:@@shared.noGs1:No GS1 labels`,
  noPins: $localize`:@@shared.noPins:No PINs`,
...
export const RouteTitles = {
  ...
  pins: $localize`:@@routes.pins:PINs`,
  pin: $localize`:@@routes.pin:Pin`,
